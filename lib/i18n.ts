...
export const translations = {
  ...
  en: {
    ...
    about: {
      ...
      p1: "Based in Berlin and , I combine years of experience in the finance and investment industry with a strong network of UHNWIs, institutional investors, fund managers, and family offices.",
